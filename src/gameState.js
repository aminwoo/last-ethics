...
import { getClass, DEFAULT_CLASS, calculateDamageTaken } from './classes.js'
...
export function getWaveComposition() {
  return WAVE_SETTINGS.composition[
    Math.min(gameState.currentWave, WAVE_SETTINGS.composition.length - 1)
  ]
}
